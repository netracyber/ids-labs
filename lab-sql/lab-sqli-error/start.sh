...
# SQL Injection Error-Based Lab Startup Script

echo "=========================================="
echo "  SQL Injection Lab - Error-Based Edition"
echo "  Starting Up..."
echo "=========================================="
echo ""
...
# Start the lab
echo ""
echo "Starting Error-Based SQL Injection Lab..."
echo ""
...
if [ -n "$PORT" ]; then
    ...
    echo ""
    echo "Challenge: Leak the flag through database"
    echo "         error messages!"
    echo ""
    echo "To view logs:"
    if [ "$USE_COMPOSE" = true ]; then

...
trackHit('api-security-easy-4');

$flag = file_exists('/var/flags/flag1.txt') ? trim(file_get_contents('/var/flags/flag1.txt')) : 'IDS{api_security_easy_4_placeholder}';
$users = [
...
if (strpos($uri, '/api/') === 0) {
        if ($uri === '/api/profile' && $method === 'PUT') {
            ...
            if (($updated['role'] ?? '') === 'admin') {
                trackFlag('api-security-easy-4', $flag);
...
<head>
    ...
    <title>API Security Easy 4 - Mass Assignment</title>
    <style>
...
<div class="wrap">
    <div class="hero">
        ...
        <h1>API Security Easy 4 - Mass Assignment</h1>
        <p>The profile update logic merges attacker-controlled fields into the user object.</p>
    </div>

    <div class="grid">
        <div class="card">
            <strong>Objective</strong>
            <p>Log in as alice and submit a profile update that includes role=admin.</p>
            <div class="hint"><strong>Hint:</strong> Try PUT /api/profile with {"role":"admin"}.</div>
        ...
        <div class="card">
            ...
            <div style="margin-top:10px;">
                ...
                <textarea id="body">{"role":"admin"}</textarea>
            </div>

...
# SQL Injection Boolean-Based Lab Startup Script

echo "=========================================="
echo "  SQL Injection Lab - Boolean-Based"
echo "  Starting Up..."
echo "=========================================="
echo ""
...
# Start the lab
echo ""
echo "Starting Boolean-Based SQL Injection Lab..."
echo ""
...
if [ -n "$PORT" ]; then
    ...
    echo ""
    echo "Challenge: Extract the flag by observing"
    echo "         TRUE/FALSE response differences!"
    echo ""
    echo "To view logs:"
    if [ "$USE_COMPOSE" = true ]; then

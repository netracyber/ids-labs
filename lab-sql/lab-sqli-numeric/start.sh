...
# SQL Injection Numeric Parameter Lab Startup Script

echo "=========================================="
echo "  SQL Injection Lab - Numeric Injection"
echo "  Starting Up..."
echo "=========================================="
echo ""
...
# Start the lab
echo ""
echo "Starting Numeric SQL Injection Lab..."
echo ""
...
if [ -n "$PORT" ]; then
    ...
    echo ""
    echo "Challenge: Exploit the numeric ID parameter"
    echo "         No quotes needed!"
    echo ""
    echo "Example URL:"
    echo "  http://localhost:${PORT}/?id=1"
    echo ""
    echo "To view logs:"
    if [ "$USE_COMPOSE" = true ]; then
